...
{
       0,    69,    69,    72,    81,    82,    83,    84,    85,    86,
      87,    88,    89,    90,    91,    92,    93,   110,   114,   119
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'+'", "'!'", "'('", "')'", "$accept", "input", "expr", "arglist", YY_NULLPTR
};
#endif
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, Expr** root, int* error_count)
{
...
#line 93 "parser.y" /* yacc.c:1646  */
    {
    (yyval.expr) = malloc(sizeof(Expr));
    (yyval.expr)->fn = FindFunction((yyvsp[-3].str));
    if ((yyval.expr)->fn == NULL) {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "unknown function \"%s\"", (yyvsp[-3].str));
        yyerror(root, error_count, buffer);
        YYERROR;
    }
    (yyval.expr)->name = (yyvsp[-3].str);
    (yyval.expr)->argc = (yyvsp[-1].args).argc;
    (yyval.expr)->argv = (yyvsp[-1].args).argv;
    (yyval.expr)->start = (yyloc).start;
    (yyval.expr)->end = (yyloc).end;
}
...
#line 114 "parser.y" /* yacc.c:1646  */
    ...
    (yyval.args).argv[0] = (yyvsp[0].expr);
}
...
#line 119 "parser.y" /* yacc.c:1646  */
    {
    (yyval.args).argc = (yyvsp[-2].args).argc + 1;
    (yyval.args).argv = realloc((yyval.args).argv, (yyval.args).argc * sizeof(Expr*));
    (yyval.args).argv[(yyval.args).argc-1] = (yyvsp[0].expr);
}
